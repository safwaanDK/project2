      ...
      <div  className='flex flex-col lg:flex-row justify-between'>
        ...
        <div>
           ...
           <div className='flex justify-between flex-wrap'>
            ...
            <button onClick={() => filterType('salad')} className='border-orange-600 text-orange-600 hover:bg-orange-600 m-1 hover:text-white'>Salads</button>
            <button onClick={() => filterType('chicken')} className='border-orange-600 text-orange-600 hover:bg-orange-600 m-1 hover:text-white'>Chicken</button>
           </div>
